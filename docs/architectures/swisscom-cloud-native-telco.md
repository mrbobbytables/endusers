...
> Imported from the [CNCF Cloud Native Reference Architecture project](https://github.com/cncf/architecture/tree/3ddf917facd0aea9694cc9c12c52e583fd2f86cb/content/en/architectures/swisscom-cloud-native-telco). Source revision: `3ddf917facd0aea9694cc9c12c52e583fd2f86cb`. Documentation is distributed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).

## Relevant Projects

### CNCF Projects

  <CNCFProjectCard name={"Kubernetes"} href={"https://www.cncf.io/projects/kubernetes/"} logo={"/img/cncf-projects/kubernetes-kubernetes-icon-color.svg"} since={"2021"} description={"The Kubernetes API is the database backend and control plane of the entire automation platform. It acts as the runtime for all CNFs, operators, and platform services. Custom Resource Definitions extend the API to cover telco-specific concerns like IPAM, DNS, and network function configuration."} />

  <CNCFProjectCard name={"Flux"} href={"https://www.cncf.io/projects/flux/"} logo={"/img/cncf-projects/flux-flux-icon-color.svg"} since={"2022"} description={"Flux is the GitOps engine for continuous reconciliation. It monitors Git repositories and synchronizes all desired state — CNF deployment manifests, Custom Resources, DNS endpoints, certificate requests, IP claims, and test definitions — into Kubernetes clusters."} />

  <CNCFProjectCard name={"cert-manager"} href={"https://www.cncf.io/projects/cert-manager/"} logo={"/img/cncf-projects/cert-manager-cert-manager-icon-color.svg"} since={"2023"} description={"Automated certificate lifecycle management integrated with Swisscom's internal PKI. Certificate requests are expressed as Kubernetes CRs, reconciled by Flux, and managed by cert-manager. Private keys never leave the cluster."} />
  ...
  <CNCFProjectCard name={"Kubebuilder / controller-runtime"} href={"https://www.cncf.io/projects/kubebuilder-/-controller-runtime/"} logo={"/img/cncf-projects/kubernetes-kubernetes-icon-color.svg"} since={"2022"} description={"Scaffolding framework and libraries for building custom Kubernetes operators. Used to build all domain-specific operators for CNF configuration abstraction, IPAM integration, config synchronization, and DNS automation."} />
...
![Cloud Native Telco Automation Layers](/img/architectures/swisscom-cloud-native-telco/swisscom-cloud-native-telco-automation-layers.svg)
...
![Cloud Native Telco Automation Architecture Overview](/img/architectures/swisscom-cloud-native-telco/swisscom-cloud-native-telco-automation-architecture-overview.png)
